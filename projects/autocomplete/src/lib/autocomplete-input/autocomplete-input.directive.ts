...
export class AutocompleteInputDirective implements ControlValueAccessor, Validator {
  ...
  @Input() suggestionsQueryList!: QueryList<AutocompleteSuggestionDirective>;
  ...
  constructor(private inputRef: ElementRef<HTMLInputElement>, private changeDetectorRef: ChangeDetectorRef) {}
